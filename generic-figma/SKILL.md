...
## Goal
Use this skill for Figma design context extraction.
...
## References
- `references/generic-figma-mcp-config.md` — setup, verification, troubleshooting, and link-based usage reminders.
- `references/generic-figma-tools-and-prompts.md` — tool catalog and prompt patterns for selecting frameworks/components and fetching metadata.
