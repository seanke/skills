...
## Goal
Use this skill for DOCX document creation and editing.
...
- Write final artifacts under `output/microsoft-docx/` when working in this repo.
...
DOCX -> PDF:
```
soffice -env:UserInstallation=file:///tmp/lo_profile_$$ --headless --convert-to generic-pdf --outdir $OUTDIR $INPUT_DOCX
```

PDF -> PNGs:
```
pdftoppm -png $OUTDIR/$BASENAME.generic-pdf $OUTDIR/$BASENAME
```
